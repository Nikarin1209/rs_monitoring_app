...
class _HistoryCalendarScreenState extends State<HistoryCalendarScreen> {
  ...
  int _level(DiaryEntry e) {
    if (e.fatigue <= 4 && e.pain <= 3 && e.mood >= 6) return 1;
    if (e.fatigue >= 7 || e.pain >= 7 || e.mood <= 3) return 3;
    return 2;
  }
  ...
  Widget build(BuildContext context) {
    ...
    for (final e in diary.entries) {
      if (e.dateTime.year == _month.year &&
          e.dateTime.month == _month.month) {
    ...
    final selectedEntry =
        _selectedDay != null ? entryMap[_selectedDay] : null;
                            ...
                            return GestureDetector(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  ...
                                  border: isSelected
                                      ? Border.all(
                                          color: NLColors.accent, width: 1.5)
                    ...
                    if (_selectedDay != null) ...[
                      ...
                      if (selectedEntry != null)
                        GestureDetector(
                          ...
                          child: NLCard(
                            child: Column(children: [
                              _DetailRow('Усталость',
                                  '${selectedEntry.fatigue} / 10'),
                              const SizedBox(height: 10),
                              _DetailRow(
                                  'Боль', '${selectedEntry.pain} / 10'),
                              const SizedBox(height: 10),
                              _DetailRow('Настроение',
                                  '${selectedEntry.mood} / 10'),
                              const SizedBox(height: 10),
                              _DetailRow('Сон',
                                  '${selectedEntry.sleepHours.toStringAsFixed(1)} ч'),
                          ...
                          child: Center(
                            child: Padding(
                              ...
                              child: Column(children: [
                                ...
                                const Text('Нет записи за этот день',
                                    style: TextStyle(
                                        fontSize: 15,
                                        fontWeight: FontWeight.w500,
                                        color: NLColors.ink)),
                                const SizedBox(height: 4),
                                const Text('Выберите другой день или добавьте запись',
                                    style: TextStyle(
